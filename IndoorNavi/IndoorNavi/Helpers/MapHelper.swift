...
public class MapHelper: NSObject {
    ...
    /// - Returns: `INPoint` describing location of the point given in real dimensions.
    ...
    ///
    /// - Parameters:
    ///   - realCoordinates: `INPoint` describing location of the point given in real dimensions
    ///   - scale: `Scale` of the map.
